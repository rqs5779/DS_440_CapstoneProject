...
setting1 = {"metric": 'mae', "time_budget": 4800}
setting2 = {"metric": 'mae', "time_budget": 600}
...
automl2 = AutoML()
automl2.fit(X_train, y2, task="regression", starting_points=automl1.best_config_per_estimator, **setting2)


# third model
y3 = y_train.iloc[:, [2]].squeeze()
automl3 = AutoML()
automl3.fit(X_train, y3, task="regression", starting_points=automl2.best_config_per_estimator, **setting2)

# fourth model
y4 = y_train.iloc[:, [3]].squeeze()
automl4 = AutoML()
automl4.fit(X_train, y4, task="regression", starting_points=automl3.best_config_per_estimator, **setting2)

# fifth model
y5 = y_train.iloc[:, [4]].squeeze()
automl5 = AutoML()
automl5.fit(X_train, y5, task="regression", starting_points=automl4.best_config_per_estimator, **setting2)

# sixth model
y6 = y_train.iloc[:, [5]].squeeze()
automl6 = AutoML()
automl6.fit(X_train, y6, task="regression", starting_points=automl5.best_config_per_estimator, **setting2)
