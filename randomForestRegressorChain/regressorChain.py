...
# Random Forest with Regressor Chain
from sklearn.ensemble import RandomForestRegressor
reg = RandomForestRegressor(n_estimators=20, random_state=0)
ChainRegression = RegressorChain(reg)
ChainRegression.fit(X_train, y_train)

y_pred1 = ChainRegression.predict(X_test)
y_pred2 = ChainRegression.predict(X_test)
y_pred3 = ChainRegression.predict(X_test)
y_pred4 = ChainRegression.predict(X_test)

# ## Regressor Chain Models
# # Linear Regressor Chain With SVM
...
# wrapper = RegressorChain(model, order=[0,1,2,3])
# wrapper.fit(X_train, y_train)


# y_pred1 = wrapper.predict(X_test)
# y_pred2 = wrapper.predict(X_test)
# y_pred3 = wrapper.predict(X_test)
# y_pred4 = wrapper.predict(X_test)
