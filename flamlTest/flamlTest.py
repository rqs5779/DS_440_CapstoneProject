...
y1 = y_train['PM2.5']
automl1 = AutoML()
automl1.fit(X_train, y1, task="regression", time_budget=600, **setting)
# status
print('model1 status')
...
y2 = y_train['PM10']
automl2 = AutoML()
automl2.fit(X_train, y2, task="regression", time_budget=120, **setting)
# status
print('model2 status')
...
y3 = y_train['SO2']
automl3 = AutoML()
automl3.fit(X_train, y3, task="regression", time_budget=120, **setting)
# status
print('model3 status')
...
y4 = y_train['NO2']
automl4 = AutoML()
automl4.fit(X_train, y4, task="regression", time_budget=120, **setting)
# status
print('model4 status')
